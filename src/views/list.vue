  ...
  <div>
    <div v-if="items.length">
      ...
      <div class="d-flex justify-content-center container">
        <nav aria-label="...">
          <ul class="pagination">
            <li v-if="pages.startPage > 1" class="page-item disabled">
              <a
                href="#"
                @click="movePage(pages.startPage - 1)"
                class="page-link"
                tabindex="-1"
                >Previous</a
              >
            ...
            <li
              class="page-item"
              v-for="i in range(pages.startPage, pages.endPage)"
              v-bind:key="i"
            >
              <a href="#" @click="movePage(i)" class="page-link">{{ i }}</a>
            </li>

            <li v-if="pages.endPage < pages.totalPage" class="page-item">
              <a
                href="#"
                @click="movePage(pages.endPage + 1)"
                class="page-link"
                tabindex="-1"
                >Next</a
              >
